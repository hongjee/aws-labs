...
# Reference: https://github.com/awslabs/multi-model-server/blob/master/examples/ssd/ssd_service.py
...
class SSDService(MXNetVisionService):
    ...
    def __init__(self):
        ...
        # You can experiment with different threshold to see the best threshold for ssd_service.py use-case.
        self.threshold = 0.2
